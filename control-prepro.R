...
# Import data & clean ----
control_hsct_data <-
  read_excel("../data/hsct-data-updated.xlsx", sheet = "hsct")

control_iq_data <- 
  read_excel("../data/neuropsych-data.xlsx", sheet = "iq")
...
# Save out data ----
save(control_hsct_data, file = "../output/control-hsct-data.RData")
save(control_iq_data,   file = "../output/control-iq-data.RData")
save(control_demo_data, file = "../output/control-demo-data.RData")
